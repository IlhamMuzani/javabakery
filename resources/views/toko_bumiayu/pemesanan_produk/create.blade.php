...
@section('content')
    ...
    <style>
        ...
        .form-group input {
            flex: 1;
            /* Allows input to fill the remaining space */
        }
    </style>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('toko_bumiayu/pemesanan_produk') }}">Pemesanan
                                Produk</a></li>
    ...
    <section class="content" onload="showPaymentFields()">
        <div class="container-fluid">
            ...
            @endif
            <form id="pemesananForm" action="{{ url('toko_bumiayu/pemesanan_produk') }}" method="POST"
                            ...
                            <div class="card-body collapse show" id="cardContent">
                                ...
                                <div class="row mb-3 align-items-center">
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <select class="form-control" id="kategori" name="kategori">
                                            ...
                                            <option value="member" {{ old('kategori') == 'member' ? 'selected' : null }}>
                                                Member</option>
                                            <option value="nonmember"
                                                {{ old('kategori') == 'nonmember' ? 'selected' : null }}>Non Member</option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-3 align-items-center" id="namaPelangganRow" style="display: none;">
                                    ...
                                    <div class="col-md-12 mb-3 ">
                                        <input hidden type="text" class="form-control" id="kode_pelanggan"
                                            name="kode_pelanggan" value="{{ old('kode_pelanggan') }}"
                                            onclick="showCategoryModalpemesanan()">
                            ...
                            <div class="card-body">
                                <div class="row mb-3 align-items-center">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group date" id="tanggal_kirim_date"
                                            data-target-input="nearest">
                                            <input type="text" id="tanggal_kirim" name="tanggal_kirim"
                                                class="form-control datetimepicker-input"
                                                data-target="#tanggal_kirim_date" value="{{ old('tanggal_kirim') }}"
                                                placeholder="DD/MM/YYYY">
                                            <div class="input-group-append" data-target="#tanggal_kirim_date"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group date" id="waktu_kirim_time" data-target-input="nearest">
                                            ...
                                            <div class="input-group-append" data-target="#waktu_kirim_time"
                                                data-toggle="datetimepicker">
                ...
                <div class="row mb-3">
                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col mb-3 d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control large-font" id="sub_total"
                                            name="sub_total" value="Rp0" oninput="updateCalculations();">
                                    </div>
                                </div>
                                <div class="row" hidden>
                                    <div class="col mb-3 d-flex align-items-center">
                                        <label for="sub_totalasli" class="mr-2" style="width: 150px;">Sub Total
                                            Asli</label>
                                        <input type="text" class="form-control large-font" id="sub_totalasli"
                                            name="sub_totalasli" value="Rp0" oninput="updateCalculations();">
                                    </div>
                                </div>
                                <div class="row" id="payment-row">
                                    <div class="col mb-3 d-flex align-items-center">
                                        <label for="dp_pemesanan" class="mr-2" style="width: 150px;">DP</label>
                                        <input type="text" class="form-control large-font" id="dp_pemesanan"
                                            name="dp_pemesanan" value="{{ old('dp_pemesanan') }}"
                                            oninput="formatAndUpdateKembali()">
                                    </div>
                                </div>
                                <div class="row" id="change-row">
                                    <div class="col mb-3 d-flex align-items-center">
                                        <label for="kekurangan_pemesanan" class="mr-2"
                                            style="width: 150px;">Kurang</label>
                                        <input type="text" class="form-control large-font" id="kekurangan_pemesanan"
                                            name="kekurangan_pemesanan" value="{{ old('kekurangan_pemesanan') }}"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" style="flex: 8;">
                            ...
                            <select class="select2bs4 select2-hidden-accessible" name="metode_id" style="width: 100%;"
                                id="nama_metode" onchange="getData1()">
                                <option value="">- Pilih -</option>
                                @foreach ($metodes as $metode)
                                    <option value="{{ $metode->id }}" data-fee="{{ $metode->fee }}"
                                        {{ old('metode_id') == $metode->id ? 'selected' : '' }}>
                                        {{ $metode->nama_metode }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <table id="datatables4" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($pelanggans as $item)
                                    <tr
                                        onclick="getSelectedDataPemesanan('{{ $item->nama_pelanggan }}', '{{ $item->telp }}', '{{ $item->alamat }}', '{{ $item->kode_pelanggan }}')">
                            ...
                            <tbody>
                                @foreach ($produks as $item)
                                    @php
                                        ...
                                        $stokpesanan_tokobumiayu = $item->stokpesanan_tokobumiayu
                                            ? $item->stokpesanan_tokobumiayu->jumlah
                                            : 0; // Jika stok ada, tampilkan, jika tidak tampilkan 0

                                    @endphp
                                    <tr class="pilih-btn" data-id="{{ $item->id }}"
                                        data-kode="{{ $item->kode_produk }}" data-lama="{{ $item->kode_lama }}"
                                        data-catatan="{{ $item->catatanproduk }}" data-nama="{{ $item->nama_produk }}"
                                        ...
                                        <td>
                                            <span
                                                class="member_harga_bmy">{{ $tokobumiayu ? $tokobumiayu->member_harga_bmy : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="member_diskon_bmy">{{ $tokobumiayu ? $tokobumiayu->member_diskon_bmy : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_harga_bmy">{{ $tokobumiayu ? $tokobumiayu->non_harga_bmy : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_diskon_bmy">{{ $tokobumiayu ? $tokobumiayu->non_diskon_bmy : '' }}</span>
                                        </td>

                                        <td class="text-center">
                                            <button type="button" class="btn btn-primary btn-sm pilih-btn"
                                                data-id="{{ $item->id }}" data-kode="{{ $item->kode_produk }}"
    ...
    <script>
        ...
        function getData(qrcode_pelanggan) {
            ...
            $.ajax({
                ...
                method: 'GET',
                data: {
                    qrcode_pelanggan: qrcode_pelanggan
                },
                success: function(response) {
    ...
    <script>
        ...
        function itemPembelian(urutan, key, value = null) {
            ...
            item_pembelian += '<td style="width: 5%; font-size:14px" class="text-center" id="urutan-' + urutan + '">' +
                urutan + '</td>';
            item_pembelian += '<td hidden><div class="form-group"><input type="text" class="form-control" id="produk_id-' +
                urutan + '" name="produk_id[]" value="' + produk_id + '"></div></td>';
            item_pembelian += '<td style="width: 10%" hidden onclick="showCategoryModal(' + urutan +
                ')"><div class="form-group"><input type="text" class="form-control" style="font-size:14px" readonly id="kode_produk-' +
                urutan + '" name="kode_produk[]" value="' + kode_produk + '"></div></td>';
            item_pembelian += '<td style="width: 10%" onclick="showCategoryModal(' + urutan +
                ')"><div class="form-group"><input type="text" class="form-control" style="font-size:14px" readonly id="kode_lama-' +
                urutan + '" name="kode_lama[]" value="' + kode_lama + '"></div></td>';
            item_pembelian += '<td style="width: 30%" onclick="showCategoryModal(' + urutan +
                ')"><div class="form-group"><input type="text" class="form-control" style="font-size:14px" readonly id="nama_produk-' +
                urutan + '" name="nama_produk[]" value="' + nama_produk + '"></div></td>';
            item_pembelian +=
                '<td style="width: 10%" style="width: 150px"><div class="form-group"><input type="number" class="form-control" style="font-size:14px" id="jumlah-' +
                urutan + '" name="jumlah[]" value="' + jumlah + '" oninput="hitungTotal(' + urutan +
                ')" onkeydown="handleEnter(event, ' + urutan + ')"></div></td>';
            item_pembelian += '<td style="width: 10%" onclick="showCategoryModal(' + urutan +
                ')" style="width: 150px"><div class="form-group"><input type="number" class="form-control" style="font-size:14px" readonly id="diskon-' +
                urutan + '" name="diskon[]" value="' + diskon + '" ></div></td>';
            item_pembelian += '<td style="width: 10%" onclick="showCategoryModal(' + urutan +
                ')"><div class="form-group"><input type="text" class="form-control" style="font-size:14px" readonly id="harga-' +
                urutan + '" name="harga[]" value="' + harga + '"></div></td>';
            item_pembelian += '<td style="width: 10%" onclick="showCategoryModal(' + urutan +
                ')"><div class="form-group"><input type="text" class="form-control" style="font-size:14px" readonly id="total-' +
                urutan + '" name="total[]" value="' + total + '"></div></td>';
            item_pembelian += '<td style="width: 10%" hidden onclick="showCategoryModal(' + urutan +
                ')"><div class="form-group"><input type="text" class="form-control" style="font-size:14px" hidden id="totalasli-' +
                urutan + '" name="totalasli[]" value="' + totalasli + '"></div></td>';
            item_pembelian +=
                '<td style="width: 10%"><button type="button" class="btn btn-primary btn-sm" onclick="showCategoryModal(' +
                urutan +
                ')"><i class="fas fa-plus"></i></button><button style="margin-left:5px" type="button" class="btn btn-danger btn-sm" onclick="removeBan(' +
                urutan + ')"><i class="fas fa-trash"></i></button></td>';
            item_pembelian += '</tr>';
