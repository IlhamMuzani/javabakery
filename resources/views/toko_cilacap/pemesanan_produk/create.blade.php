...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('toko_cilacap/pemesanan_produk') }}">Pemesanan
                                Produk</a></li>
    ...
    <section class="content" onload="showPaymentFields()">
        <div class="container-fluid">
            ...
            @endif
            <form id="pemesananForm" action="{{ url('toko_cilacap/pemesanan_produk') }}" method="POST"
                            ...
                            <tbody>
                                @foreach ($produks as $item)
                                    ...
                                    <tr class="pilih-btn" data-id="{{ $item->id }}"
                                        ...
                                        <td>
                                            <span
                                                class="member_harga_clc">{{ $tokocilacap ? $tokocilacap->member_harga_clc : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="member_diskon_clc">{{ $tokocilacap ? $tokocilacap->member_diskon_clc : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_harga_clc">{{ $tokocilacap ? $tokocilacap->non_harga_clc : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_diskon_clc">{{ $tokocilacap ? $tokocilacap->non_diskon_clc : '' }}</span>
                                        </td>
