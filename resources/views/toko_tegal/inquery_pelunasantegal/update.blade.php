...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="{{ url('toko_tegal/inquery_pelunasantegal/' . $inquery->id) }}" method="POST"
                            ...
                            <tbody>
                                @foreach ($produks as $item)
                                    ...
                                    <tr data-id="{{ $item->id }}" data-kode="{{ $item->kode_produk }}"
                                        ...
                                        data-member="{{ $tokotegal ? $tokotegal->member_harga_bnjr : '' }}"
                                        data-diskonmember="{{ $tokotegal ? $tokotegal->member_diskon_bnjr : '' }}"
                                        data-nonmember="{{ $tokotegal ? $tokotegal->non_harga_bnjr : '' }}"
                                        data-diskonnonmember="{{ $tokotegal ? $tokotegal->non_diskon_bnjr : '' }}"
                                        ...
                                        <td>
                                            <span
                                                class="member_harga_bnjr">{{ $tokotegal ? $tokotegal->member_harga_bnjr : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="member_diskon_bnjr">{{ $tokotegal ? $tokotegal->member_diskon_bnjr : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_harga_bnjr">{{ $tokotegal ? $tokotegal->non_harga_bnjr : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_diskon_bnjr">{{ $tokotegal ? $tokotegal->non_diskon_bnjr : '' }}</span>
                                        </td>
        ...
        document.getElementById('kategori').addEventListener('change', function() {
            ...
            if (selectedValue === 'penjualan') {
                window.location.href =
                    "{{ route('toko_tegal.penjualan_produk.create') }}"; // Ganti dengan route yang sesuai untuk Penjualan
            } else if (selectedValue === 'pelunasan') {
                window.location.href =
                    "{{ route('toko_tegal.penjualan_produk.pelunasan') }}"; // Ganti dengan route yang sesuai untuk Pelunasan
            }
        });
    </script>
    ...
    <script>
        ...
        function removePesanan(identifier) {
            ...
            if (detailId) {
                $.ajax({
                    url: "{{ url('toko_tegal/inquery_pelunasantegal/deletedetail/') }}/" + detailId,
                    type: "POST",
                    data: {
                        _method: 'DELETE',
                        _token: '{{ csrf_token() }}'
