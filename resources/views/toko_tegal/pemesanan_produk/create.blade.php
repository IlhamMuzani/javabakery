...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('toko_tegal/pemesanan_produk') }}">Pemesanan Produk</a>
                        </li>
    ...
    <section class="content" onload="showPaymentFields()">
        <div class="container-fluid">
            ...
            @endif
            <form id="pemesananForm" action="{{ url('toko_tegal/pemesanan_produk') }}" method="POST"
                            ...
                            <tbody>
                                @foreach ($produks as $item)
                                    @php
                                        ...
                                        $stokpesanan_tokotegal = $item->stokpesanan_tokotegal
                                            ? $item->stokpesanan_tokotegal->jumlah
                                    ...
                                    <tr class="pilih-btn" data-id="{{ $item->id }}"
                                        ...
                                        <td>
                                            <span
                                                class="member_harga_tgl">{{ $tokotegal ? $tokotegal->member_harga_tgl : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="member_diskon_tgl">{{ $tokotegal ? $tokotegal->member_diskon_tgl : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_harga_tgl">{{ $tokotegal ? $tokotegal->non_harga_tgl : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_diskon_tgl">{{ $tokotegal ? $tokotegal->non_diskon_tgl : '' }}</span>
                                        </td>
