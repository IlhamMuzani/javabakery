...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('toko_pemalang/pemesanan_produk') }}">Inquery Pemesanan
                                Produk</a>
                        </li>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{ url('toko_pemalang/inquery_pemesananproduk/' . $inquery->id) }}" method="post"
                autocomplete="off">
                @csrf
                @method('put')
                <div class="container">
    ...
    <script>
        ...
        function removePesanan(identifier) {
            ...
            if (detailId) {
                $.ajax({
                    url: "{{ url('toko_pemalang/inquery_pemesananpemalang/deletedetail/') }}/" + detailId,
                    type: "POST",
                    data: {
                        _method: 'DELETE',
                        _token: '{{ csrf_token() }}'
