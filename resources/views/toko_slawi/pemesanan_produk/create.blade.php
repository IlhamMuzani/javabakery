...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('toko_slawi/pemesanan_produk') }}">Pemesanan Produk</a>
                        </li>
    ...
    <section class="content" onload="showPaymentFields()">
        <div class="container-fluid">
            ...
            @endif
            <form id="pemesananForm" action="{{ url('toko_slawi/pemesanan_produk') }}" method="POST"
                            ...
                            <tbody>
                                @foreach ($produks as $item)
                                    @php
                                        ...
                                        $stokpesanan_tokoslawi = $item->stokpesanan_tokoslawi
                                            ? $item->stokpesanan_tokoslawi->jumlah
                                    ...
                                    <tr class="pilih-btn" data-id="{{ $item->id }}"
                                        ...
                                        <td>
                                            <span
                                                class="member_harga_slw">{{ $tokoslawi ? $tokoslawi->member_harga_slw : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="member_diskon_slw">{{ $tokoslawi ? $tokoslawi->member_diskon_slw : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_harga_slw">{{ $tokoslawi ? $tokoslawi->non_harga_slw : '' }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="non_diskon_slw">{{ $tokoslawi ? $tokoslawi->non_diskon_slw : '' }}</span>
                                        </td>
