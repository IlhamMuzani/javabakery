...
class Inquery_pelunasanbumiayuController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('toko_bumiayu.inquery_pelunasanbumiayu.update', compact(
            'inquery',
            'barangs',
            'tokos',
            'produks',
        ...
        foreach ($data_pembelians as $data_pesanan) {
            ...
            if ($detailId) {
                ...
                if (
                    ...
                    // Pengurangan stok untuk stok_tokobumiayu
                    $stok = Stok_tokobumiayu::where('produk_id', $detail->produk_id)->first();
                } else {
                    // Jika tidak, kurangi stok dari stokpesanan_tokobumiayu
