...
class Inquery_pelunasanpemalangController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('toko_pemalang.inquery_pelunasanpemalang.update', compact(
            'inquery',
            'barangs',
            'tokos',
            'produks',
    ...
    public function update(Request $request, $id)
    {
        ...
        foreach ($data_pembelians as $data_pesanan) {
            ...
            if ($detailId) {
                ...
                if (
                    ...
                    // Pengurangan stok untuk stok_tokopemalang
                    $stok = Stok_tokopemalang::where('produk_id', $detail->produk_id)->first();
                } else {
                    // Jika tidak, kurangi stok dari stokpesanan_tokopemalang
        ...
        return redirect('toko_pemalang/inquery_pelunasanpemalang');
    }
