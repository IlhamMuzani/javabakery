...
class Inquery_pelunasancilacapController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('toko_cilacap.inquery_pelunasancilacap.update', compact(
            'inquery',
            'barangs',
            'tokos',
            'produks',
        ...
        foreach ($data_pembelians as $data_pesanan) {
            ...
            if ($detailId) {
                ...
                if (
                    ...
                    // Pengurangan stok untuk stok_tokocilacap
                    $stok = Stok_tokocilacap::where('produk_id', $detail->produk_id)->first();
                } else {
                    // Jika tidak, kurangi stok dari stokpesanan_tokocilacap
